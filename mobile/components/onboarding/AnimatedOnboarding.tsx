...
const SLIDES: OnboardingSlide[] = [
  ...
  },
  {
    ...
    title: 'Shifts & Staff on the Map',
    subtitle: 'Everything in One Place',
    description: 'Working security? Find shifts near you. Running a venue or agency? See available staff and book cover in a few taps.',
    accentColor: '#10b981',
  ...
  },
  {
    ...
    subtitle: 'Secure & On Time',
    description: 'Get paid for shifts or pay for cover — every payment is tracked securely, so the money side just works.',
    accentColor: '#f59e0b',
