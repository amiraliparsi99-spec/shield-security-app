/**
 * Shared error handling: normalize Supabase/API errors and return user-friendly messages.
 */
...
/**
 * Extract a user-friendly message from unknown error (Supabase, Error, string, etc.).
 */
...
/**
 * Get only the user-facing message (for alerts/toasts).
 */
